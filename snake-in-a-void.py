...
bgm = pygame.mixer.Sound("sfx/bgm.ogg")
ult_sound = pygame.mixer.Sound("sfx/bonus.ogg")
fruit_sound = pygame.mixer.Sound("sfx/fruit.ogg")
bomb_sound = pygame.mixer.Sound("sfx/bomb.ogg")
death_sound = pygame.mixer.Sound("sfx/death.ogg")
click_sound = pygame.mixer.Sound("sfx/click.ogg")
restart_sound = pygame.mixer.Sound("sfx/restart.ogg")
quit_sound = pygame.mixer.Sound("sfx/exit.ogg")

pygame.mixer.music.load('sfx/bgm.ogg')
pygame.mixer.music.load('sfx/bonus.ogg')
pygame.mixer.music.load('sfx/fruit.ogg')
pygame.mixer.music.load('sfx/bomb.ogg')
pygame.mixer.music.load('sfx/death.ogg')
pygame.mixer.music.load('sfx/click.ogg')
pygame.mixer.music.load('sfx/restart.ogg')
pygame.mixer.music.load('sfx/exit.ogg')
